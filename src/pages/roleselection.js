...
function Roleselection() {
 ...
 <div className="col-lg-6 left-section d-flex align-items-center justify-content-center">
        <div className="text-center px-4">
          ...
          <img src={images} alt="Career Matching Illustration" className="img-fluid main-illustration"/>
    </div>
        ...
        <div className="col-lg-6 right-section d-flex align-items-center">
         ...
         <p className="continue-subtitle">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor</p>
    </div>
          ...
          <a href="loginSeeker.html" className="user-card-link">
        ...
        <img src={woman} alt="Job Seeker" className="img-fluid"/>
            ...
            <div className="user-info">
                ...
                <p className="user-description">Let's recruit your great candidate faster here</p>
        </div>
         </div>
            </div>
        </a>
 
          <a href="loginCompany.html" className="user-card-link">
